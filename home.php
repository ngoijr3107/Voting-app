				    ...
				    <?php
				    	...
				    	if($vquery->num_rows > 0){
				    		...
				    		<div class="text-center">
					    		...
					    		<a href="#view" data-toggle="modal" class="btn btn-flat btn-primary btn-lg" style="background: #18a7a7;">View Ballot</a>
					    	</div>
				    		<?php
				    	}
				    	else{
						    ...
						    <form method="POST" id="ballotForm" action="submit_ballot.php">
				        		...
				        		?>
				        		<div class="text-center">
					        		<button type="button" class="btn btn-success btn-flat" id="preview" style="background: #2c2c40;"><i class="fa fa-file-text"></i> Preview</button> 
					        		<button type="submit" class="btn btn-primary btn-flat" name="vote" style="background: #18a7a7;"><i class="fa fa-check-square-o"></i> Submit</button>
					        	</div>
				        	</form>
				        	<!-- End Voting Ballot -->
				    		<?php
...
<!-- <script src="includes/autologout.js"></script> -->
</body>
</html>